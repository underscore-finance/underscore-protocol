...
def __init__(
    ...
    assert _yieldVaultAsset != empty(address) # dev: invalid yield vault asset
    ASSET = _asset
    UNDY_HQ = _undyHq

    # validate yield vault asset matches underlying asset
    ...
    vaultWallet.__init__(_undyHq, _asset, _yieldVaultAsset, _borrowLegoId, _startingAgent)
