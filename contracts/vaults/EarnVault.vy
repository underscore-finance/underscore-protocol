...
def _redeemFromVault(
    ...
    availAmount, currentBalAdjust = vaultWallet._prepareRedemption(_asset, _amount, _maxBalVaultToken, _sender, _vaultRegistry)
    ...
    # save data
    currentBalance: uint256 = _currentBalance - min(_currentBalance, currentBalAdjust)
    vaultWallet.lastUnderlyingBal = currentBalance
    vaultWallet.pendingYieldRealized = _pendingYieldRealized
