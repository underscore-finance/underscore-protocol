...
Result: +2-3% APY through 24/7 rebalancing
...
Savings: Significant gas reduction + perfect accounting
```
...
Save 30-50% on gas vs separate swaps
```

### Liquidity Provision
Add/remove liquidity with automatic position tracking:
- Standard pools: Lower gas costs
- Concentrated liquidity: Higher gas costs with NFT management
...
**With Underscore**:
- AI Manager rebalances daily: +$2,000/year extra yield
- Gas savings: Significant on Base L2
...
- Treasury yield optimization: +$25,000/year
...
**Annual difference for $100k portfolio**: 
- Extra yield: $2,000-3,000
- Gas savings: Significant annually
- Time savings: 200+ hours
- Mistakes prevented: Invaluable
...
**What about L2s?**
Currently mainnet only. L2 support planned.

**How do fees work?**
Small fees (0-5%) on profits only. No fees on losses or transfers.
