...
> **Archive notice (2026-07-24):** This is the build history of the paused
...
Affected files/evidence: `docs/poc/user-wallet/*`, planned `contracts/poc/userWallet/**`, planned `tests/poc/userWallet/**`.
Scope impact: None.
...
Affected files/evidence: `contracts/poc/userWallet/mocks/MockReentrantToken.vy`, `tests/poc/userWallet/conftest.py`, S1-E3, S1-E4.
Scope impact: None; both are planned test machinery.

BL-003 · 2026-07-23 · compiler control
Decision or failed assumption: All v3 artifacts deploy through `tests/poc/userWallet/conftest.py::deploy_v3`, which asserts optimizer `gas` and EVM target `cancun`.
Reason: Boa and Vyper otherwise default to compiler/execution settings that do not satisfy the evidence contract.
Affected files/evidence: `tests/poc/userWallet/conftest.py`, all v3 tests and gas evidence.
Scope impact: None.
...
Affected files/evidence: `contracts/poc/userWallet/UserWalletV3.vy`, `tests/poc/userWallet/test_yield_session.py`, S2-E1..S2-E8.
Scope impact: None.
...
Affected files/evidence: `contracts/poc/userWallet/extenders/DebtExtender.vy`, `contracts/poc/userWallet/mocks/MockDebt*.vy`, `contracts/poc/userWallet/mocks/MockOperatorProtocol.vy`, S3-E1..S3-E7.
Scope impact: None.
...
Affected files/evidence: `contracts/poc/userWallet/UserWalletV3.vy`, S5-E9.
...
Affected files/evidence: `contracts/poc/userWallet/extenders/PaymentExtender.vy`, `contracts/poc/userWallet/rails/X402Helper.vy`, `tests/poc/userWallet/test_mpp.py`, `tests/poc/userWallet/test_x402.py`, S4-E1..S4-E9.
Scope impact: None.
...
Affected files/evidence: `tests/poc/userWallet/test_future_action.py`, S5-E8, S5-E9.
...
Affected files/evidence: `contracts/poc/userWallet/extenders/FutureActionExtender.vy`, `contracts/poc/userWallet/mocks/MockFutureAction*.vy`, `contracts/poc/userWallet/mocks/MaliciousExtender.vy`, `tests/poc/userWallet/test_security.py`, `tests/poc/userWallet/test_future_action.py`.
Scope impact: None.
...
Affected files/evidence: `tests/poc/userWallet/gas/test_poc_gas.py`, S1-E6, `tests/poc/userWallet/gas/test_poc_gas.py::test_poc_gas`.
...
Affected files/evidence: `tests/poc/userWallet/gas/test_poc_gas.py`, `docs/poc/user-wallet/POC_RESULTS.md`, S1-E6, S2-E7, S4-E2, S5-E9.
...
Affected files/evidence: `contracts/poc/userWallet/UserWalletV3.vy`, `contracts/poc/userWallet/UserWalletConfigV3.vy`, `tests/poc/userWallet/test_security.py::test_s5_e1_none_route_cannot_consume_named_core_primitives`, `tests/poc/userWallet/test_transfer_and_config.py::test_s1_e3_zero_beneficiary_is_not_a_zero_consumer_exemption`.
...
Affected files/evidence: `contracts/poc/userWallet/mocks/MaliciousExtender.vy`, `contracts/poc/userWallet/mocks/MockDebtLego.vy`, `contracts/poc/userWallet/mocks/MockYieldLego.vy`, `tests/poc/userWallet/conftest.py`, `tests/poc/userWallet/test_transfer_and_config.py`, `tests/poc/userWallet/test_yield_session.py`, `tests/poc/userWallet/test_debt_and_operator.py`, `tests/poc/userWallet/test_mpp.py`, `tests/poc/userWallet/test_x402.py`, `tests/poc/userWallet/test_security.py`.
...
Affected files/evidence: `tests/poc/userWallet/gas/test_poc_gas.py`, `/tmp/wallet-v3-poc-local.json`, `/tmp/wallet-v3-poc-base.json`.
...
Affected files/evidence: `contracts/poc/userWallet/UserWalletV3.vy`, `tests/poc/userWallet/test_yield_session.py`, `tests/poc/userWallet/test_security.py::test_s5_e2_unconsumed_spend_session_cannot_settle`.
Scope impact: None.
...
Affected files/evidence: commit `397a1cf`, `tests/poc/userWallet/test_future_action.py`, `tests/poc/userWallet/test_security.py::test_s5_e9_core_runtime_size_and_compiler_settings`, S5-E8, S5-E9.
...
Affected files/evidence: `contracts/poc/userWallet/UserWalletV3.vy`, all negative tests under `tests/poc/userWallet/`, especially S1-E3, S4-E3..S4-E6, S5-E1..S5-E2.
...
Affected files/evidence: BL-011, `docs/poc/user-wallet/POC_RESULTS.md`, `/tmp/wallet-v3-poc-local.json`, `/tmp/wallet-v3-poc-base.json`.
...
Affected files/evidence: `tests/poc/userWallet/test_security.py::test_s5_e2_unconsumed_spend_session_cannot_settle`.
...
Affected files/evidence: `tests/poc/userWallet/gas/test_poc_gas.py`, `docs/poc/user-wallet/POC_RESULTS.md`, BL-014, S5-E1.
...
Affected files/evidence: `docs/poc/user-wallet/implementation-guide.md`, `docs/poc/user-wallet/user-wallet.md`, `contracts/poc/userWallet/UserWalletV3.vy`, `tests/poc/userWallet/test_security.py::test_s5_e2_unconsumed_spend_session_cannot_settle`.
...
Affected files/evidence: `contracts/poc/userWallet/mocks/MaliciousExtender.vy`, `tests/poc/userWallet/test_security.py::test_s5_e2_unconsumed_spend_session_cannot_settle`, `docs/poc/user-wallet/POC_RESULTS.md`, BL-019.
