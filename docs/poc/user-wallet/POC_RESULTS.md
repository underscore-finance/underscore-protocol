...
> **Archive notice (2026-07-24):** These results belong to the paused
...
- `tests/poc/userWallet/test_transfer_and_config.py::test_s1_e5_broken_config_can_be_replaced_without_moving_assets`
- `tests/poc/userWallet/test_extender_lifecycle.py::test_s3_e6_and_e7_debt_position_survives_successor_and_old_exact_exits`
- `tests/poc/userWallet/test_mpp.py::test_s4_e8_commitments_survive_config_and_payment_successor`
...
- `tests/poc/userWallet/test_transfer_and_config.py::test_s1_e3_rejects_invalid_config_candidates`
- `tests/poc/userWallet/test_transfer_and_config.py::test_s1_e3_reviewed_config_has_no_initializer_or_rebinding`
- `tests/poc/userWallet/test_transfer_and_config.py::test_s1_e3_zero_beneficiary_is_not_a_zero_consumer_exemption`
- `tests/poc/userWallet/test_transfer_and_config.py::test_s1_e5_broken_config_can_be_replaced_without_moving_assets`
- `tests/poc/userWallet/test_extender_lifecycle.py::test_s3_e6_and_e7_debt_position_survives_successor_and_old_exact_exits`
...
- `tests/poc/userWallet/test_yield_session.py::test_s2_e1_routed_extender_opens_once_and_direct_calls_fail`
- `tests/poc/userWallet/test_yield_session.py::test_s2_e2_empty_session_has_no_effect_or_approval`
- `tests/poc/userWallet/test_yield_session.py::test_s2_e3_and_e8_semantic_hash_binds_full_yield_action`
- `tests/poc/userWallet/test_yield_session.py::test_s2_e4_and_e5_exact_approval_cleanup_and_direct_beneficiary`
- `tests/poc/userWallet/test_yield_session.py::test_s2_e4_nested_dispatch_during_approval_rolls_back`
- `tests/poc/userWallet/test_yield_session.py::test_s2_e6_attachment_bounds_declarations_and_dependencies`
- `tests/poc/userWallet/test_extender_lifecycle.py::test_s3_e6_and_e7_debt_position_survives_successor_and_old_exact_exits`
- `tests/poc/userWallet/test_security.py::test_s5_e1_none_route_cannot_consume_named_core_primitives`
- `tests/poc/userWallet/test_security.py::test_s5_e1_hostile_active_extender_cannot_mutate_core_effect_fields`
- `tests/poc/userWallet/test_security.py::test_s5_e2_capability_reuse_cross_action_and_stale_session_fail`
- `tests/poc/userWallet/test_security.py::test_s5_e2_unconsumed_spend_session_cannot_settle`
- `tests/poc/userWallet/test_security.py::test_s5_e3_malicious_extender_cannot_use_primitives_or_general_authority`
- `tests/poc/userWallet/test_security.py::test_s5_e4_config_reentrancy_and_approval_cleanup_failure_revert_cleanly`
- `tests/poc/userWallet/test_security.py::test_s5_e4_malformed_erc20_return_fails_closed`
...
- `tests/poc/userWallet/test_yield_session.py::test_s2_e4_and_e5_exact_approval_cleanup_and_direct_beneficiary`
- `tests/poc/userWallet/test_yield_session.py::test_s2_e4_nested_dispatch_during_approval_rolls_back`
- `tests/poc/userWallet/test_debt_and_operator.py::test_s3_e1_non_allowance_effects_are_semantically_bounded`
- `tests/poc/userWallet/test_debt_and_operator.py::test_s3_e2_borrowed_and_released_assets_go_to_wallet`
- `tests/poc/userWallet/test_debt_and_operator.py::test_s3_e3_fixed_operator_target_and_lego_only`
- `tests/poc/userWallet/test_debt_and_operator.py::test_s3_e4_operator_use_outside_active_session_fails`
- `tests/poc/userWallet/test_security.py::test_s5_e1_hostile_active_extender_cannot_mutate_core_effect_fields`
- `tests/poc/userWallet/test_security.py::test_s5_e2_unconsumed_spend_session_cannot_settle`
...
- `tests/poc/userWallet/test_debt_and_operator.py::test_s3_e3_fixed_operator_target_and_lego_only`
- `tests/poc/userWallet/test_debt_and_operator.py::test_s3_e4_operator_use_outside_active_session_fails`
- `tests/poc/userWallet/test_debt_and_operator.py::test_s3_e5_active_revoke_after_config_replacement`
- `tests/poc/userWallet/test_extender_lifecycle.py::test_s3_e6_and_e7_debt_position_survives_successor_and_old_exact_exits`
- `tests/poc/userWallet/test_security.py::test_s5_e1_none_route_cannot_consume_named_core_primitives`
- `tests/poc/userWallet/test_security.py::test_s5_e1_hostile_active_extender_cannot_mutate_core_effect_fields`
...
- `tests/poc/userWallet/test_mpp.py::test_s4_e1_commitment_creation_is_active_typed_and_allowlisted`
- `tests/poc/userWallet/test_x402.py::test_s4_e2_base_constants_preflight_and_real_usdc_bytes_signature_pull`
- `tests/poc/userWallet/test_x402.py::test_s4_e3_rail_signature_exact_digest_caller_bounds_and_time`
- `tests/poc/userWallet/test_x402.py::test_s4_e4_and_e5_used_unsynced_expiry_unused_expiry_and_replay`
- `tests/poc/userWallet/test_x402.py::test_s4_e3_erc165_is_narrow`
- `tests/poc/userWallet/test_mpp.py::test_s4_e5_and_e6_partial_settlement_refund_and_terminal_replay`
- `tests/poc/userWallet/test_mpp.py::test_s4_e6_state_updates_before_transfer_and_reentrancy_rolls_back`
- `tests/poc/userWallet/test_mpp.py::test_s4_e7_reserved_value_blocks_transfer_yield_debt_and_double_commit`
- `tests/poc/userWallet/test_mpp.py::test_s4_e8_commitments_survive_config_and_payment_successor`
- `tests/poc/userWallet/test_mpp.py::test_s4_e9_token_and_helper_failures_preserve_commitment_state`
- `tests/poc/userWallet/test_security.py::test_s4_e3_and_s5_e4_non_idle_rail_answer_is_invalid`
- `tests/poc/userWallet/test_security.py::test_s5_e1_none_route_cannot_consume_named_core_primitives`
- `tests/poc/userWallet/test_security.py::test_s5_e1_hostile_active_extender_cannot_mutate_core_effect_fields`
- `tests/poc/userWallet/test_extender_lifecycle.py::test_s5_e7_old_route_collision_nonexit_and_codehash_mutation_fail`
...
- `tests/poc/userWallet/gas/test_poc_gas.py::test_poc_gas`
...
- S1-E1 through S1-E5: all seven nodes in `test_transfer_and_config.py`; S1-E6: `tests/poc/userWallet/gas/test_poc_gas.py::test_poc_gas`.
...
- S5-E1: `tests/poc/userWallet/test_security.py::test_s5_e1_none_route_cannot_consume_named_core_primitives` and `tests/poc/userWallet/test_security.py::test_s5_e1_hostile_active_extender_cannot_mutate_core_effect_fields`.
- S5-E2: `tests/poc/userWallet/test_security.py::test_s5_e2_capability_reuse_cross_action_and_stale_session_fail` and `tests/poc/userWallet/test_security.py::test_s5_e2_unconsumed_spend_session_cannot_settle`.
- S5-E3: `tests/poc/userWallet/test_security.py::test_s5_e3_malicious_extender_cannot_use_primitives_or_general_authority`.
- S5-E4: `tests/poc/userWallet/test_security.py::test_s4_e3_and_s5_e4_non_idle_rail_answer_is_invalid`, `tests/poc/userWallet/test_security.py::test_s5_e4_config_reentrancy_and_approval_cleanup_failure_revert_cleanly`, and `tests/poc/userWallet/test_security.py::test_s5_e4_malformed_erc20_return_fails_closed`.
- S5-E5: `tests/poc/userWallet/test_x402.py::test_s4_e3_rail_signature_exact_digest_caller_bounds_and_time`, `tests/poc/userWallet/test_x402.py::test_s4_e4_and_e5_used_unsynced_expiry_unused_expiry_and_replay`, and `tests/poc/userWallet/test_mpp.py::test_s4_e7_reserved_value_blocks_transfer_yield_debt_and_double_commit`.
- S5-E6: `tests/poc/userWallet/test_mpp.py::test_s4_e5_and_e6_partial_settlement_refund_and_terminal_replay` and `tests/poc/userWallet/test_mpp.py::test_s4_e6_state_updates_before_transfer_and_reentrancy_rolls_back`.
- S5-E7: `tests/poc/userWallet/test_extender_lifecycle.py::test_s5_e7_old_route_collision_nonexit_and_codehash_mutation_fail`.
- S5-E8: `tests/poc/userWallet/test_future_action.py::test_s5_e8_future_asset_release_needs_no_core_change`.
- S5-E9: `tests/poc/userWallet/test_security.py::test_s5_e9_core_runtime_size_and_compiler_settings`.
