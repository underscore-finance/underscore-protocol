...
def migrate(migration: Migration):
    ...
    aid = migration.execute(
        ...
        10_000 * 10**6, # _maxDepositAmount: uint256,
    ...
    print("USDC Vault initialized", aid)
    ...
    aid = migration.execute(
        ...
        True, # _canDeposit: bool,
        True, #_canWithdraw: bool,
        25 * 10**18, # _maxDepositAmount: uint256,
        2_00, # _redemptionBuffer: uint256,
    ...
    assert migration.execute(switchboard_charlie.executePendingAction, aid)
    print("ETH Vault initialized", aid)
    ...
    aid = migration.execute(
        ...
        True, # _canDeposit: bool,
        True, #_canWithdraw: bool,
        10**7, # _maxDepositAmount: uint256,
        2_00, # _redemptionBuffer: uint256,
