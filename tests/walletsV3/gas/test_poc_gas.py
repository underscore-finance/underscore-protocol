...
def test_poc_gas(
    ...
    try:
        ...
        boundary = deploy_v3("contracts/walletsV3/mocks/MockGasBoundary.vy")
        ...
        wallet_v3 = deploy_v3("contracts/walletsV3/UserWalletV3.vy", bob)
        config_v3 = deploy_v3(
        ...
        if fork == "local":
            ...
            yield_wallet = deploy_v3("contracts/walletsV3/UserWalletV3.vy", bob)
            ...
            mpp_wallet = deploy_v3("contracts/walletsV3/UserWalletV3.vy", bob)
            ...
            x_wallet = deploy_v3("contracts/walletsV3/UserWalletV3.vy", bob)
            helper = deploy_v3(
