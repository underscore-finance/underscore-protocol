...
def test_s4_e7_reserved_value_blocks_transfer_yield_debt_and_double_commit(
    ...
    yield_lego = deploy_v3("contracts/poc/userWallet/mocks/MockYieldLego.vy")
    vault = deploy_v3(
        "contracts/poc/userWallet/mocks/MockVault.vy",
        stack["token"].address,
    )
    ...
    debt_lego = deploy_v3("contracts/poc/userWallet/mocks/MockDebtLego.vy")
    debt_protocol = deploy_v3("contracts/poc/userWallet/mocks/MockDebtProtocol.vy")
    operator_protocol = deploy_v3("contracts/poc/userWallet/mocks/MockOperatorProtocol.vy")
    debt_extender = deploy_v3(
        "contracts/poc/userWallet/extenders/DebtExtender.vy",
        debt_lego.address,
...
def test_s4_e9_token_and_helper_failures_preserve_commitment_state(
    ...
    stack = payment_stack
    false_token = deploy_v3("contracts/poc/userWallet/mocks/MockMalformedToken.vy")
