...
def test_s3_e6_and_e7_debt_position_survives_successor_and_old_exact_exits(
    ...
    protocol = deploy_v3("contracts/poc/userWallet/mocks/MockDebtProtocol.vy")
    operator = deploy_v3("contracts/poc/userWallet/mocks/MockOperatorProtocol.vy")
    lego_v1 = deploy_v3("contracts/poc/userWallet/mocks/MockDebtLego.vy")
    lego_v2 = deploy_v3("contracts/poc/userWallet/mocks/MockDebtLego.vy")
    ...
    broken = deploy_v3(
        "contracts/poc/userWallet/mocks/MockBrokenConfig.vy",
        wallet.address,
    )
...
def test_s5_e7_old_route_collision_nonexit_and_codehash_mutation_fail(
    ...
    protocol = deploy_v3("contracts/poc/userWallet/mocks/MockDebtProtocol.vy")
    operator = deploy_v3("contracts/poc/userWallet/mocks/MockOperatorProtocol.vy")
    lego = deploy_v3("contracts/poc/userWallet/mocks/MockDebtLego.vy")
    extender_v1 = deploy_v3(
        "contracts/poc/userWallet/extenders/DebtExtender.vy",
        lego.address,
        operator.address,
