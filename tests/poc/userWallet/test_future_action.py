...
# The archive move changed only module import paths in the core source. The
# compiled Step 4 runtime identity remains pinned separately below.
STEP4_SOURCE_SHA256 = "122e07cd9d4ea054ee75399ca7c8f7c0a36726473e61499d3130549d40224d56"
STEP4_RUNTIME_KECCAK = "682824564c5a39465190151c30c9b73cb4e4e2aa2a466fc1ded0c2b467394a4b"
STEP4_RUNTIME_SIZE = 11_985
...
def test_s5_e8_future_asset_release_needs_no_core_change(
    ...
    core_path = REPO_ROOT / "contracts/poc/userWallet/UserWalletV3.vy"
    ...
    lego = deploy_v3("contracts/poc/userWallet/mocks/MockFutureActionLego.vy")
    protocol = deploy_v3("contracts/poc/userWallet/mocks/MockFutureActionProtocol.vy")
    extender = deploy_v3(
        "contracts/poc/userWallet/extenders/FutureActionExtender.vy",
        lego.address,
    )
