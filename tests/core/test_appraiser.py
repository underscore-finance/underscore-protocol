...
# NOTE: getNormalAssetPrice() and updateAndGetNormalAssetPrice() have been COMPLETELY REMOVED
# These functions no longer exist in the simplified Appraiser
...
# NOTE: getPricePerShare() and updateAndGetPricePerShare() have been COMPLETELY REMOVED
# These functions no longer exist in the simplified Appraiser
# The lastPricePerShare() function returns fresh price from YieldLego (no caching)


# NOTE: getPrice() has been COMPLETELY REMOVED
# This function no longer exists in the simplified Appraiser
...
# NOTE: Ripe snapshot integration tests removed
# The test fixtures don't have the necessary mock methods to test snapshot behavior
# In production, updatePriceAndGetUsdValue would trigger Ripe snapshots for earn vaults


# Snapshot test removed - fixtures don't support vault registry mock methods


# NOTE: Backpack permission test removed
# The test fixtures don't have the necessary mock methods for backpack registry
# In production, registered backpack items can call updatePriceAndGetUsdValueAndIsYieldAsset
