...
def test_compoundV3_deposit_max(
    ...
    testLegoDeposit(lego_compound_v3, asset, vault_token)
...
def test_compoundV3_deposit_partial(
    ...
    testLegoDeposit(lego_compound_v3, asset, vault_token, amount // 2)
...
@pytest.mark.parametrize("token_str", TEST_ASSETS)
@pytest.always
def test_compoundV3_view_functions(
    token_str,
    getVaultToken,
    lego_compound_v3,
    ...
    vault_token = getVaultToken(token_str)
    testLegoViewFunctions(lego_compound_v3, vault_token, token_str)