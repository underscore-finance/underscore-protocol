...
# Test trial funds restriction
def test_cannot_migrate_with_trial_funds(migrator, hatchery, bob, alpha_token, alpha_token_whale, setUserWalletConfig):
    """Test that wallets with trial funds cannot be migrated"""
    ...
    # Cannot migrate wallet with trial funds
    assert not migrator.canMigrateFundsToNewWallet(wallet_with_trial, new_wallet, bob)
