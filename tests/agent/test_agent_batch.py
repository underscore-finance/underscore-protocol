...
def user_wallet(hatchery, bob, mock_lego_asset, mock_lego_asset_alt, mock_lego_vault, mock_lego_debt_token, whale, setManagerConfig, agent, setAssetConfig): # must load `agent` here!
