...
class CONFIG_ACTION_TYPE(IntFlag):
    ...
    LOOT_PARAMS = 64  # 2^6
    AGENT_TEMPLATE = 128  # 2^7
    AGENT_CREATION_LIMITS = 256  # 2^8
    STARTER_AGENT_PARAMS = 512  # 2^9
    MANAGER_CONFIG = 1024  # 2^10
    PAYEE_CONFIG = 2048  # 2^11
    CAN_PERFORM_SECURITY_ACTION = 4096  # 2^12
    ASSET_CONFIG = 8192  # 2^13
    ASSET_TX_FEES = 16384  # 2^14
    ASSET_AMBASSADOR_REV_SHARE = 32768  # 2^15
    ASSET_YIELD_CONFIG = 65536  # 2^16
    IS_STABLECOIN = 131072  # 2^17
