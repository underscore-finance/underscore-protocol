...
class CONFIG_ACTION_TYPE(IntFlag):
    ...
    WALLET_CREATION_LIMITS = 2  # 2^1 (moved up after TRIAL_FUNDS removal)
    KEY_ACTION_TIMELOCK_BOUNDS = 4  # 2^2
    DEFAULT_STALE_BLOCKS = 8  # 2^3
    TX_FEES = 16  # 2^4
    AMBASSADOR_REV_SHARE = 32  # 2^5
    DEFAULT_YIELD_PARAMS = 64  # 2^6
    LOOT_PARAMS = 128  # 2^7
    AGENT_TEMPLATE = 256  # 2^8
    AGENT_CREATION_LIMITS = 512  # 2^9
    STARTER_AGENT_PARAMS = 1024  # 2^10
    MANAGER_CONFIG = 2048  # 2^11
    PAYEE_CONFIG = 4096  # 2^12
    CAN_PERFORM_SECURITY_ACTION = 8192  # 2^13
    ASSET_CONFIG = 16384  # 2^14
